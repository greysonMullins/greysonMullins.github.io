...
function clearCards() {
    ...
    document.getElementById("houseCard1").innerHTML = ""; 
    document.getElementById("houseCard2").innerHTML = "";
    document.getElementById("houseCard3").innerHTML = "";
    document.getElementById("houseCard4").innerHTML = "";
    document.getElementById("houseCard5").innerHTML = "";
    document.getElementById("houseCard6").innerHTML = "";
}